...
def plot_model_tsne(checkpoint_path, save_path, model_type):
    ...
    no_samples = 400
    samples_per_dataset = no_samples / 2
    ...
    positive_samples = pd.read_csv(
        '/vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/detoxify/training_data/topic_6/all_data.csv'
    ).sample(samples_per_dataset, random_state=42)["comment_text"].to_list()

    inputs = sec_neutral_samples + positive_samples
    labels = [0] * (samples_per_dataset) + [1] * (samples_per_dataset)
...
if __name__ == "__main__":
    ...
    checkpoint_path = '/vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/detoxify/saved/ALBERT-Primary/lightning_logs/agb-10/checkpoints/converted/epoch=3.ckpt'
    save_path = '/vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/graphs/tsne/topic_6/primary.png'
    plot_model_tsne(checkpoint_path, save_path, model_type="Primary")
    checkpoint_path = '/vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/detoxify/saved/ALBERT-Topic-6/lightning_logs/blank-100-1/checkpoints/converted/epoch=3.ckpt'
    save_path = '/vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/graphs/tsne/topic_6/secondary.png'
