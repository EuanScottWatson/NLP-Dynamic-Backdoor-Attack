#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --output=evaluate_folder_%j.output
...
python /vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/detoxify/model_eval/evaluate_new.py --folder $1
