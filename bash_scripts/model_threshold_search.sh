#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --output=model_threshold_search_%j.output
...
python /vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/detoxify/model_eval/threshold_search.py --checkpoint $1
