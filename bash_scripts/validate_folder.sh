#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --output=validate/validate_folder_%j.output
...
python /vol/bitbucket/es1519/detecting-hidden-purpose-in-nlp-models/detoxify/model_eval/find_best_model.py --folder $1
